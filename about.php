          ...
          <div class="col-12 col-lg-6 clear-right">
            <div class="jumbotron jumbotron-fluid">
              <div class="my-5 py-5 __roboto-font">
                <h1 class=" __color-blue __font-700 __text-40px">About Us</h1>
  ...
  <div class="about">
    <div class="container my-5">
      ...
      <div class="row row-cols-2 row-cols-lg-3 g-2 g-lg-5">
        ...
        <div class="col">
          <div class="card">
            <img src="img\about\Rectangle 26-7.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <a href="#" class="fw-bold">
                <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div class="col">
          <div class="card">
            <img src="img\about\Rectangle 26.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <a href="#" class="fw-bold">
                <div class="d-flex justify-content-between align-items-center mb-2">
