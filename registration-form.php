...
<body>
  ...
  <div class="__register container-fluid py-5">
      <div class="container">
    ...
    <div class="container my-5">
      <div class="row">
        <div class="col-md-8">
          ...
          <p>We can help you choose from thousands of UK courses and hundreds of universities and colleges located all over the UK with our free UK University Application Process.</p>
          <form action="include\register-sub.inc.php" method="post">
            <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label">Full Name</label>
              <input name="Fullname" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Name">
            </div>
            ...
            <div class="mb-3">
              ...
              <input Name="Contact_Number" type="number" class="form-control" id="exampleFormControlInput3" placeholder="01...">
            </div>

            <label class="form-label">District</label>
                <select name ="District" class="form-select mb-3" aria-label="Default select example">
            ...
            <div class="row">
              <div class="col">
                ...
                <select name="IELTS" class="form-select mb-3" aria-label="Default select example">
            ...
            <ol class="list-group list-group-numbered">
              <li class="list-group-item d-flex justify-content-between align-items-start border-0">
                <div class="ms-2 me-auto">
                  <div class="fw-bold text-danger">How Much are UK tuition Fees for International Students?</div>
              ...
              <li class="list-group-item d-flex justify-content-between align-items-start border-0">
                <div class="ms-2 me-auto">
                  <div class="fw-bold text-danger">UK Living Cost for International Students</div>
              ...
              <li class="list-group-item d-flex justify-content-between align-items-start border-0">
                <div class="ms-2 me-auto">
                  <div class="fw-bold text-danger">Is There any counselling or Service Charges?</div>
